...
public class dd_amazonpage {

	public static void main(String[] args) throws IOException {
		// TODO Auto-generated method stub
			FileInputStream f=new FileInputStream("C:\\Users\\ychan\\OneDrive\\Documents\\dd1_amazonpage.xlsx");
			...
			for(int i=0;i<drop1.size();i++)
			{
				...
				FileOutputStream f2=new FileOutputStream("C:\\Users\\ychan\\OneDrive\\Documents\\dd1_amazonpage.xlsx");
				wb.write(f2);
				f2.close();
