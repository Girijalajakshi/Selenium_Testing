...
public class linksexe {
	...
	public static void main(String[] args) throws IOException {
	    ...
	    d.findElement(By.xpath("/html/body/div[2]/table/tbody/tr/td[1]/table/tbody/tr/td/table/tbody/tr/td/table/tbody/tr[1]/td[2]")).click();
		List<WebElement> drop1=d.findElements(By.tagName("a"));
